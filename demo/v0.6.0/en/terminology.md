# Terminology - MII Implementation Guide Module Template v2027.0.0-template.0.6.0
...
> [TODO: If your module uses SNOMED CT, state the edition/version used. List the module's own ValueSets/CodeSystems, or refer to the automatically generated artifact list. If your module wants to place a binding requirement about expansions on implementers, state it on the Conformance pages with an explicit `§…§` marker — this page is not part of the Conformance section.]
