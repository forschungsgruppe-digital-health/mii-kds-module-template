# General Requirements - MII Implementation Guide Module Template v2027.0.0-template.0.6.0
...
This page documents the requirements that apply to the whole **Module Template** module and to every MII actor implementing it.
