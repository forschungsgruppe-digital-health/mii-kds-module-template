# Example Patient — template starter - MII Implementation Guide Module Template v2027.0.0-template.0.10.2
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/modul-template/StructureDefinition/example-patient | *Version*:2027.0.0-template.0.10.2 |
...
```json
{
  ...
  "meta" : {
    ...
    },
    {
      ...
      {
        "url" : "version",
        "valueString" : "2027.0.0-template.0.10.2"
      },
      {
        "url" : "uri",
  ...
  "version" : "2027.0.0-template.0.10.2",
  "name" : "ExamplePatient",
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-08-14T12:09:38+00:00",
  "publisher" : "NUM-DIZ",
  "_publisher" : {
    "extension" : [{
      "extension" : [{
