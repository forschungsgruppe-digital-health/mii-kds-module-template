# Search Parameters - MII Implementation Guide Module Template v2027.0.0-template.0.10.2
...
This page lists the module-specific FHIR search parameters of the **Module Template** module (naming convention `MII_SP_<Module>_<Name>`), where defined. Cross-module search parameters are defined by the Meta module.
