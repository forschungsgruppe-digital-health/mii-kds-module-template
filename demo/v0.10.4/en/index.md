# Home - MII Implementation Guide Module Template v2027.0.0-template.0.10.4
...
| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/modul-template/ImplementationGuide/mii-ig-template | *Version*:2027.0.0-template.0.10.4 |
...
| :--- | :--- |
| Date | 2027-01-01 |
| Version | 2027.0.0-template.0.10.4 (CalVer`YYYY.n.n`) |
| Status | active |
| Realm | DE |
