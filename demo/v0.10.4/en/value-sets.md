# Value Sets - MII Implementation Guide Module Template v2027.0.0-template.0.10.4
...
This page describes the ValueSets of the **Module Template** module (naming convention `MII_VS_<Module>_<Name>`). For general guidance on using codes, see [FHIR Terminology](http://hl7.org/fhir/R4/terminologies.html); the code systems the sets draw from are described on the [Code Systems](code-systems.md) page.
