# mii-param-template-manifest - MII Implementation Guide Module Template v2027.0.0-template.0.10.4

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **mii-param-template-manifest**

## Parameters: mii-param-template-manifest
...
```json
{
  ...
  "id" : "mii-param-template-manifest",
  "meta" : {
  ...
  {
    "name" : "default-canonical-version",
    "valueCanonical" : "https://www.medizininformatik-initiative.de/fhir/modul-template/StructureDefinition/example-patient|2027.0.0-template.0.10.4"
  },
  {
    "name" : "default-canonical-version",
