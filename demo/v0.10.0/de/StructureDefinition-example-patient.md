# Example Patient — template starter - MII Implementation Guide Module Template v2027.0.0-template.0.10.0

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **Example Patient — template starter**

## Ressourcenprofil: Example Patient — template starter 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/modul-template/StructureDefinition/example-patient | *Version*:2027.0.0-template.0.10.0 |
| Active Stand: 2026-08-14 | *Maschinenlesbarer Name*:ExamplePatient |
...
```json
{
  ...
  "meta" : {
    ...
    },
    {
      ...
      {
        "url" : "version",
        "valueString" : "2027.0.0-template.0.10.0"
      },
      {
        "url" : "uri",
  ...
  "version" : "2027.0.0-template.0.10.0",
  "name" : "ExamplePatient",
  ...
  "_title" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "Beispiel-Patient — Vorlagenbeispiel"
      }],
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-08-14T10:27:50+00:00",
  "publisher" : "NUM-DIZ",
  "_publisher" : {
    "extension" : [{
      "extension" : [{
  ...
  "_description" : {
    "extension" : [{
      ...
      {
        "url" : "content",
        "valueString" : "Minimales Beispielprofil, das nur mit der Vorlage ausgeliefert wird, damit ein neu erstelltes Modul sofort eine gerenderte IG erzeugt. Kein MII-Artefakt — ersetzen Sie es durch die Profile Ihres Moduls."
      }],
      "url" : "http://hl7.org/fhir/StructureDefinition/translation"
    }]
  },
