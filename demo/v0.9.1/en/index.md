# Home - MII Implementation Guide Module Template v2027.0.0-template.0.9.1
...
| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/modul-template/ImplementationGuide/mii-ig-template | *Version*:2027.0.0-template.0.9.1 |
...
| :--- | :--- |
| Date | 2027-01-01 |
| Version | 2027.0.0-template.0.9.1 (CalVer`YYYY.n.n`) |
| Status | active |
| Realm | DE |
