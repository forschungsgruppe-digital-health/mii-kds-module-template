# ValueSets - MII Implementation Guide Module Template v2027.0.0-template.0.10.5
...
Diese Seite beschreibt die ValueSets des Moduls **Module Template** (Namenskonvention `MII_VS_<Modul>_<Name>`). Allgemeine Hinweise zur Verwendung von Codes: siehe [FHIR Terminology](http://hl7.org/fhir/R4/terminologies.html); die zugrunde liegenden CodeSystems beschreibt die Seite [CodeSystems](code-systems.md).
