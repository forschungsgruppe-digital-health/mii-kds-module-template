# Extensions - MII Implementation Guide Module Template v2027.0.0-template.0.10.5
...
Diese Seite listet die FHIR-Extensions, die das Modul **Module Template** definiert (Namenskonvention `MII_EX_<Modul>_<Name>`). Extensions transportieren Informationen, die die Basis-Ressourcen und Profile nicht ausdrücken können; die Profile, die sie verwenden, stehen auf der Seite [Profile](profiles.md).
