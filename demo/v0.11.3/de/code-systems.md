# CodeSystems - MII Implementation Guide Module Template v2027.0.0-template.0.11.3
...
Diese Seite beschreibt die CodeSystems des Moduls **Module Template** (Namenskonvention `MII_CS_<Modul>_<Name>`). Die darauf aufbauenden ValueSets beschreibt die Seite [ValueSets](value-sets.md).
