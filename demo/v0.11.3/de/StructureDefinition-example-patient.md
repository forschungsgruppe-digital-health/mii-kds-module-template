# Example Patient — template starter - MII Implementation Guide Module Template v2027.0.0-template.0.11.3
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/modul-template/StructureDefinition/example-patient | *Version*:2027.0.0-template.0.11.3 |
| Active Stand: 2026-08-27 | *Maschinenlesbarer Name*:ExamplePatient |
...
```json
{
  ...
  "meta" : {
    ...
    },
    {
      ...
      {
        "url" : "version",
        "valueString" : "2027.0.0-template.0.11.3"
      },
      {
        "url" : "uri",
  ...
  "version" : "2027.0.0-template.0.11.3",
  "name" : "ExamplePatient",
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-08-27T16:16:37+00:00",
  "publisher" : "NUM-DIZ",
  "_publisher" : {
    "extension" : [{
      "extension" : [{
