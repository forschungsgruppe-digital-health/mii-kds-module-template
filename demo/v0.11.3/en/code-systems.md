# Code Systems - MII Implementation Guide Module Template v2027.0.0-template.0.11.3
...
This page describes the CodeSystems of the **Module Template** module (naming convention `MII_CS_<Module>_<Name>`). The ValueSets built on them are described on the [Value Sets](value-sets.md) page.
