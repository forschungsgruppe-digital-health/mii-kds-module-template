# Example Patient — template starter - MII Implementation Guide Module Template v2027.0.0-template.0.11.0
...
| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/modul-template/StructureDefinition/example-patient | *Version*:2027.0.0-template.0.11.0 |
| Active as of 2026-08-19 | *Computable Name*:ExamplePatient |
...
```json
{
  ...
  "meta" : {
    ...
    },
    {
      ...
      {
        "url" : "version",
        "valueString" : "2027.0.0-template.0.11.0"
      },
      {
        "url" : "uri",
  ...
  "version" : "2027.0.0-template.0.11.0",
  "name" : "ExamplePatient",
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-08-19T20:19:38+00:00",
  "publisher" : "NUM-DIZ",
  "_publisher" : {
    "extension" : [{
      "extension" : [{
