# Versionierung - MII Implementation Guide Module Template v2027.0.0-template.0.10.1
...
* Format **`JJJJ.MINOR.PATCH[-label]`** — die aktuelle Version ist `2027.0.0-template.0.10.1`;
