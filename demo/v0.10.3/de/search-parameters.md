# Suchparameter - MII Implementation Guide Module Template v2027.0.0-template.0.10.3
...
Diese Seite listet die modul-spezifischen FHIR-Suchparameter des Moduls **Module Template** (Namenskonvention `MII_SP_<Modul>_<Name>`), sofern definiert. Modulübergreifende Suchparameter definiert das Meta-Modul.
