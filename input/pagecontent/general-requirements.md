...
* §general-2:Servers **SHOULD** declare support for a profile by including its official URL in `CapabilityStatement.rest.resource.supportedProfile`§. The official
